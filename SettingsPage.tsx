...
export default function SettingsPage() {
    // Default to 'frontend-test' if nothing is set to avoid fetch errors on first load
    const [currentMode, setCurrentMode] = useState(() => localStorage.getItem('appMode') || 'frontend-test');
                        ...
                        <fieldset className="space-y-3">
                            ...
                            <div className="flex items-center gap-4 p-4 rounded-md bg-gray-700/50 border border-gray-700">
                                ...
                                <label htmlFor="complete-mode" className="text-white cursor-pointer">
                                    ...
                                    <span className="block text-sm text-gray-400">Conecta ao backend e ao banco de dados SQL.</span>
                                </label>
                            </div>
                             <div className="flex items-center gap-4 p-4 rounded-md bg-gray-700/50 border border-gray-700">
                                <input
